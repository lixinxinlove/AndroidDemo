...
public class GestureLockView extends View {
    ...
    private List<Integer> linedCycles = new ArrayList<>();
    ...
    public interface OnGestureFinishListener {
        void OnGestureFinish(boolean success, String gestureCode);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, widthMeasureSpec);  //方块
    }
